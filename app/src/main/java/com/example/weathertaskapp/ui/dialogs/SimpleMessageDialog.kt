...
class SimpleMessageDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        configureDialog()
        val view: View = inflater.inflate(R.layout.dialog_simple_message, container, false)
        initView(view)
...
//            dialog!!.window!!.attributes.windowAnimations = R.style.DialogAnimation
    ...
    public fun showDialog(){
        this.show(parentFragmentManager, SimpleMessageDialog::class.java.simpleName)
    }
}